...
class Anchor3DHeadV2(nn.Module, AnchorTrainMixin):
    ...
    def forward_train(self, x, valid, img_metas, gt_bboxes_3d, gt_labels_3d):
        x = self(x)
        losses = self.loss(*x, valid, gt_bboxes_3d, gt_labels_3d, img_metas)
        return losses
    ...
    def loss_single(self, cls_score, bbox_pred, dir_cls_preds, valid, labels,
